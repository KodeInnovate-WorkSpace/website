      ...
      <div className="pt-[4rem]">
        ...
        <section
          ...
          >
            ...
            >
              DDP is India’s largest integrated platform for Real Estate & Mortgages and one of the fastest growing
              Proptech platform in Mumbai and UAE. DDP platform offers an integrated consumer experience & covers the
              full real-estate journey from search & discovery, transactions, home loans, interiors, rentals, property
            ...
            <div className="md:w-1/2 w-full flex flex-col lg:flex-row lg:space-x-8 space-y-2 lg:space-y-0">
              <div className="h-[20rem] w-full flex flex-col items-center p-4 md:p-6 rounded-tr-[2rem]">
                ...
                <div className="my-2">
                  ...
                  >
                    To provide seamless experiences from search to post-sales service, making property transactions
                    effortless.
                  </p>
                </div>
              </div>
              ...
              <div className="h-[27rem] w-full flex flex-col items-center p-4 md:p-6 rounded-tr-[2rem]">
                ...
                <div className="my-2">
                  ...
                  <p
                      ...
                      className="text-left font-semibold"
                  >
                    Revolutionizing real estate and mortgages with an integrated platform to simplify every step of the
                    property journey.
                  </p>
                </div>
              </div>
